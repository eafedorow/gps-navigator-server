...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Администратор', description: `Значение роли пользователя` }),
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING, unique: true, allowNull: false }),
    __metadata("design:type", String)
], Role.prototype, "value", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Имеет возможность редактировать список пользователей', description: `Описание роли` }),
